...
# Ensure PyAutoGUI doesn't automatically fail on screen edges
pyautogui.FAILSAFE = False

# Mediapipe drawing and hands solutions setup
...
def password_prompt():
    ...
    password_entry = tk.Entry(root, show="*", font=('Arial', 10), bd=5)
    password_entry.pack(pady=10)

    check_button = tk.Button(root, text="Check Password", command=check_password, bg='blue2', fg='white', font=('Arial', 10, 'bold'))
...
def select_dominant_hand():
    ...
    note_label.pack(pady=0)  # Adjust padding as needed
